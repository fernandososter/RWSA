...
class EMGSubwindowFeatureEncoder(nn.Module):
    """Encoder local sobre sub-janelas intramini-época.

    Extrai features simples em K sub-janelas de 250 ms dentro da mini-época
    de 3 s e usa uma Conv1D temporal curta para preservar ordem e duração antes
    de reduzir tudo a um único embedding por mini-época.
    """
    ...
    def __init__(self, config: ModelConfig | None = None):
        ...
        # RMS, MAV e STD do canal principal; amplitude relativa média quando
        # o pipeline já fornece o canal baseline-relative.
