...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--rswa-stage-conditioning-mode",
        choices=["full_probs", "prem_only"],
        default="prem_only",
        help=(
            "Modo de condicionamento do ramo RSWA pelo staging: todas as "
            "probabilidades de estágio ou apenas p(REM)."
        ),
    )
    parser.add_argument(
...
def main() -> None:
    ...
    rswa_model_cfg = ModelConfig(
        ...
        rswa_stage_conditioning_mode=args.rswa_stage_conditioning_mode,
    ...
    with ExperimentLogger(
        ...
        with ResourceMonitor(
            ...
            logger.info(
                ...
                f"stage_conditioning_mode={args.rswa_stage_conditioning_mode} "
